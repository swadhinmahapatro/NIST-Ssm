...
$mon_sub_4= mysqli_escape_string($con, $_POST['mon_sub_4']);
...
$mon_tec_4= mysqli_escape_string($con, $_POST['mon_tec_4']);
...
$tue_sub_4= mysqli_escape_string($con, $_POST['tue_sub_4']);
...
$tue_tec_4= mysqli_escape_string($con, $_POST['tue_tec_4']);
...
$wed_sub_4= mysqli_escape_string($con, $_POST['wed_sub_4']);
...
$wed_tec_4= mysqli_escape_string($con, $_POST['wed_tec_4']);
...
$thu_sub_4= mysqli_escape_string($con, $_POST['thu_sub_4']);
...
$thu_tec_4= mysqli_escape_string($con, $_POST['thu_tec_4']);
...
$fri_sub_4= mysqli_escape_string($con, $_POST['fri_sub_4']);
...
$q_18="INSERT INTO `time_table` (`sub_name`, `t_name`, `period`, `day`, `class_id`) VALUES ('$mon_sub_4', '$mon_tec_4', '4', 'Monday', '$class');";
...
$q_19="INSERT INTO `time_table` (`sub_name`, `t_name`, `period`, `day`, `class_id`) VALUES ('$tue_sub_4', '$tue_tec_4', '4', 'Tuesday', '$class');";
...
$q_20="INSERT INTO `time_table` (`sub_name`, `t_name`, `period`, `day`, `class_id`) VALUES ('$wed_sub_4', '$wed_tec_4', '4', 'Wednesday', '$class');";
...
$q_21="INSERT INTO `time_table` (`sub_name`, `t_name`, `period`, `day`, `class_id`) VALUES ('$thu_sub_4', '$thu_tec_4', '4', 'Thursday', '$class');";
...
$q_23="INSERT INTO `time_table` (`sub_name`, `t_name`, `period`, `day`, `class_id`) VALUES ('$fri_sub_4', '$fri_tec_4', '4', 'Friday', '$class');";
...
$q_22="INSERT INTO `time_table` (`sub_name`, `t_name`, `period`, `day`, `class_id`) VALUES ('$sat_sub_3', '$sat_tec_3', '3', 'Saturday', '$class');";
...
$q_result_17= mysqli_query($con, $q_18) or die(mysqli_error($con));
$q_result_17= mysqli_query($con, $q_19) or die(mysqli_error($con));
$q_result_17= mysqli_query($con, $q_20) or die(mysqli_error($con));
$q_result_17= mysqli_query($con, $q_21) or die(mysqli_error($con));
$q_result_17= mysqli_query($con, $q_22) or die(mysqli_error($con));
$q_result_17= mysqli_query($con, $q_23) or die(mysqli_error($con));
