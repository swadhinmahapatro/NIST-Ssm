        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <h1>RFC List <i class="fa-regular fa-rectangle-list"></i></h1>
...
<?php
$i=1;
$qu=mysqli_query($con,"SELECT * from rfc where status='pending'") or die(mysqli_error($con));
while($rfc=mysqli_fetch_array($qu)){
    echo '<tr class="table-primary">';
    echo '<td>'.$i.'</td><td>'.$rfc['p_id'].'</td><td>'.$rfc['attr'].'</td><td>'.$rfc['value'].'</td><td><a href="rfc/'.$rfc['file'].'"><i class="fa-regular fa-file"></i></a></td><td><div class="d-flex justify-content-between"><i class="fa-solid fa-circle-check text-success" role="button" onclick="appr(this,'.$rfc['id'].');" title="Approve"></i><i class="fa-solid fa-circle-xmark text-danger" role="button" onclick="rej(this,'.$rfc['id'].');" title="Reject"></i></div></td></tr>';
    $i++;
}
?>
</tbody>
