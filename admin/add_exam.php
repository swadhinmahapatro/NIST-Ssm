...
<body id="page-top">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">Test Information</h1>
                    <div class="card shadow mb-4">
                        <form action="exam_submit.php" method="post" onsubmit="return checkform(this);">
                        <div class="card-body">
                            
                                <label for="chaeck" class="form-inline">Test Name</label>
                                ...
                                <br>
                                <label for="sub" class="form-inline">Subject</label>
                                <select id="sub" class="form-control" name="sub">
                                    <option value="0">--Please Select--</option>
                                </select>
                                <br>
                                <label for="no" class="form-inline">Number of MCQ</label>
                                <input type="number" class="form-control" name="nos" id="no" required><br>
                                <label for="mark" class="form-inline">Weightage of each question</label>
                                <input type="number" class="form-control" name="mark" id="mark" required><br>
    ...
    <script>
        function checkform(val){
            ...
            if(val.sub.value==0){
                document.getElementById("sub").classList.add("border-danger");
                return false;
            }
            return true;
        }
        function react(v){
            ...
            xhr.onreadystatechange=function(){
                if(xhr.readyState==4 && xhr.status==200){
                    var res="<option value='0'>--Please Select--</option>"+xhr.responseText;
                    document.getElementById("sub").innerHTML=res;
                }
            }
            xhr.open("POST","getSub.php",true);
            xhr.setRequestHeader("Content-Type","application/x-www-form-urlencoded");
            xhr.send("sub="+v.value);
        }
